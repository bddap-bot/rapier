...
impl VelocitySolver {
    ...
    pub fn solve_constraints(
        ...
        for substep_id in 0..num_substeps {
            ...
            // inject net linear momentum (bddap/rl#321).
    ...
    pub fn integrate_positions(
        ...
        for link in &self.multibody_roots {
            ...
            // substep: `update_dynamics` derives link velocities from them, and
            ...
            multibody.update_link_velocities(bodies);
            ...
            // mass matrix.
            multibody.update_inertias(params.dt, bodies);
